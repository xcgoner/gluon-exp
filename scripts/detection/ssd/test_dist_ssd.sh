...
python /home/ubuntu/gluon-exp/scripts/detection/ssd/train_ssd.py --gpus $OMPI_COMM_WORLD_RANK --batch-size 16 --network resnet50_v1 --data-shape 512 --dataset voc --lr 0.001 --lr-decay-epoch 160,200 --lr-decay 0.1 --epochs 240 --kv-store dist_sync
